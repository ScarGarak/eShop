...
public class Mitarbeiter extends Person{
	...
	/**
	 * Eine leere Konstruktor Funktion, die es ermšglicht eine Instanz dieses Objektes zu erstellen,
	...
	/**
	 * Eine Konstruktor Funktion, die es ermšglicht das ID Attribut gleich zu Anfang zu initialisieren,
	 * und spŠter die Andern.
	...
	/**
	 * Eine Konstruktor Funktion, die es ermšglicht gleich zu Anfang alle Attribute zu initialisieren.
	...
	// => Das ist gar nicht nštig, denn diese wird schon von 'Object' geerbt und ist schon implementiert.
	//    Wir mŸssen diese Methode nur Ÿberschreiben und unseren BedŸrfnissen anpassen.
